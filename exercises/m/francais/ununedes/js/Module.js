m.francais.ununedes.Module = function (e) {
...
// xs devices
        ...
        var image = $('<img/>', {
            style: 'width: 50%',
            src: 'exercises/m/francais/lelales/img/card_8.png'
        });
...
// xs devices
        ...
        var image = $('<img/>', {
            style: 'width: 80%',
            src: 'exercises/m/francais/ununedes/img/example.png'
        });
    ...
    this.buildQuestion = function (div, currentExercise, currentModule) {
        ...
        if (currentExercise == 1) {
            if (!view) {
                view = new m.francais.ununedes.View(this, div, 25, 0, 24,
            ...
            if (!view) {
                view = new m.francais.ununedes.View(this, div, 25, 25, 49,
            ...
            if (!view) {
                view = new m.francais.ununedes.View(this, div, 25, 50, 74,
                    n * this.getQuestionNumber(currentExercise, currentModule));
            } else {
                view.restart(div, n * this.getQuestionNumber(currentExercise, currentModule));
            }
            ...
            if (!view) {
                view = new m.francais.ununedes.View(this, div, 25, 75, 99,
                    n * this.getQuestionNumber(currentExercise, currentModule));
            } else {
                view.restart(div, n * this.getQuestionNumber(currentExercise, currentModule));
            }
            ...
            if (!view) {
                view = new m.francais.ununedes.View(this, div, 25, 100, 124,
                    n * this.getQuestionNumber(currentExercise, currentModule));
            } else {
                view.restart(div, n * this.getQuestionNumber(currentExercise, currentModule));
            }
    ...
    this.getName = function() {
        return 'Déterminants : un, une, des';
    };
