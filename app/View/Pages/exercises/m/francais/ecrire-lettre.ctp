...
echo $this->Html->script('exercises/m/francais/ecrire-lettre/Topic');
echo $this->Html->script('exercises/m/francais/ecrire-lettre/Controller');
echo $this->Html->script('exercises/m/francais/ecrire-lettre/Model');
echo $this->Html->script('exercises/m/francais/ecrire-lettre/Module');
echo $this->Html->script('exercises/m/francais/ecrire-lettre/View');
?>

<script language="javascript">
    $(document).ready(function () {
        var e = new engine('exercises/m/exercise-m', '<?php echo $this->webroot; ?>');
        var module = new m.francais.ecrirelettre.Module(e, '<?php echo $this->webroot; ?>');
