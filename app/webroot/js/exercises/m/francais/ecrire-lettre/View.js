m.francais.ecrirelettre.View = function (mdl, u, div, number, min, max, sh, n) {
...
// public methods
    ...
    this.init = function (mdl, u, view, number, min, max, sh, n) {
...
// xs and sm devices
    ...
    var draw_letters = function (canvas) {
        ...
        var img = new Image();
        img.src = url + 'img/exercises/m/francais/ecrire-lettre/card_' + model.getImageIndex() + '.png';
...
// private attributes
    ...
    this.init(mdl, u, div, number, min, max, sh, n);
};