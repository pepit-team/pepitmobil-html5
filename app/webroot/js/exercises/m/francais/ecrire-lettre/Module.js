m.francais.ecrirelettre.Module = function (e, u) {
...
// xs devices
        ...
        var image = $('<img/>', {
            style: 'width: 50%',
            src: url + 'img/exercises/m/francais/ecrire-lettre/card_1.png'
        });
...
// xs devices
        ...
        var image = $('<img/>', {
            style: 'width: 80%',
            src: url + 'img/exercises/m/francais/ecrire-lettre/example.png'
        });
    ...
    this.buildQuestion = function (div, currentExercise, currentModule) {
        ...
        if (currentExercise == 1) {
            view = new m.francais.ecrirelettre.View(this, url, div, 5, 0, 4, 0, 5);
        } else if (currentExercise == 2) {
            view = new m.francais.ecrirelettre.View(this, url, div, 5, 5, 9, 0, 5);
        } else if (currentExercise == 3) {
            view = new m.francais.ecrirelettre.View(this, url, div, 5, 10, 14, 0, 6);
        } else if (currentExercise == 4) {
            view = new m.francais.ecrirelettre.View(this, url, div, 5, 15, 19, 0, 6);
        }
        questionIndex = 1;
