m.francais.ununedes.Module = function (e, u) {
...
// public methods
    ...
    this.buildQuestion = function (div, currentExercise, currentModule) {
        ...
        if (currentExercise == 1) {
            if (!view) {
                view = new m.francais.ununedes.View(this, url, div, 25, 0, 24,
            ...
            if (!view) {
                view = new m.francais.ununedes.View(this, url, div, 25, 25, 49,
            ...
            if (!view) {
                view = new m.francais.ununedes.View(this, url, div, 25, 50, 74,
                    n * this.getQuestionNumber(currentExercise, currentModule));
            } else {
                view.restart(div, n * this.getQuestionNumber(currentExercise, currentModule));
            }
            ...
            if (!view) {
                view = new m.francais.ununedes.View(this, url, div, 25, 75, 99,
                    n * this.getQuestionNumber(currentExercise, currentModule));
            } else {
                view.restart(div, n * this.getQuestionNumber(currentExercise, currentModule));
            }
            ...
            if (!view) {
                view = new m.francais.ununedes.View(this, url, div, 25, 100, 124,
                    n * this.getQuestionNumber(currentExercise, currentModule));
            } else {
                view.restart(div, n * this.getQuestionNumber(currentExercise, currentModule));
            }
