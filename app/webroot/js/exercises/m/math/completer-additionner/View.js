...
// public methods
    ...
    this.update = function () {
        ...
        if (model.isOkResult()) {
            ...
            $('#img_result_md_lg').attr('src', url + 'img/exercises/m/math/completer-additionner/card_' +
                model.getResult() + '.png');
            $('#img_result_xs_sm').attr('src', url + 'img/exercises/m/math/completer-additionner/card_' +
                model.getResult() + '.png');
            module.next();
        } else {
            $('#result_md_lg').html('?');
